    ...
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-lg-5 px-5 pt-5">
                <h1 class="font-weigt-bold py-3" style="color:white;">UDML</h1>
                <h4 style="color:white;">Sign into your account</h4> 
                <form method='post' action='login_check.php'>
                    <div class="form-row Forrm">
                        <div class="col-lg-7">
                            <input type="email" name='fmail' class="form-control my-3 p-3" placeholder="Email-Address">
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="col-lg-7">
                            <input type="password" name='fpass' class="form-control my-3 p-3" placeholder="*******">
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="col-lg-7">
                            <button type="submit" class="btn mt-3 mb-5" style="color:white;">Login</button></a>
                        </div>
                    </div>

                    <a href="#">Forgot Password ?</a>
                    <p style="color:white;">Don't have an account? <a href="#">Register here</a></p>
